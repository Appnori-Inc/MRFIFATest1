...
namespace BallPool
{
    ...
    {
        public static AightBallPoolPlayer CurrentTurnPlayer { get => mainPlayer.myTurn ? mainPlayer : otherPlayer; }
        ...
        public AightBallPoolPlayer(int playerId, string name, int coins, string uuid = "") : base(playerId, name, coins, uuid)
        {
            _isStripes = false;
            _isSolids = false;
            isBlack = false;
