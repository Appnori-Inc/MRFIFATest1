...
namespace BallPool
{
    ...
    public class GameUIController : MonoBehaviour
    {
        ...
        public bool is3D { get => true; set { /*nothing in VR*/ } }
        /// <summary>
        /// The shot on up.
        /// </summary>
        ...
        public void Play()
        {
            ...
            SceneManager.LoadScene(Billiards.GameConfig.TableSceneName, LoadSceneMode.Additive);
        }
        ...
        public void Rematch(bool nextStage)
        {
            ...
            else
            {
                ...
                if(nextStage)
                {
                    ...
                    //Billiards.Initializer.SinglePlayInitializer(GameDataManager.level);
                }
        ...
        public void GoHome()
        {
            GameDataManager.instance.SetVRDevicePico();
            physicsManager.Disable();
            if (NetworkManager.mainPlayer != null)
            {
                NetworkManager.mainPlayer.state = PlayerState.Online;
