...
namespace BallPool
{
    public class CaromGameManager : BallPoolGameManager
    {
        private bool onBallHitPocket = false;
        private bool playAgainMenuIsActive;


        public CaromGameLogic gameLogic { get; set; }


        public CaromGameManager()
        {
            gameLogic = new CaromGameLogic();
        }
        ...
        {
            CaromGameLogic.gameState.gameIsComplete = true;
        ...
        public override void OnEndShot(string data)
        {
            ...
            {
                CallOnEndShot();
                if (CaromGameLogic.gameState.needToChangeTurn)
                {
        ...
        void PhysicsManager_OnBallHitBall(BallListener ball, BallListener hitBall, bool inMove)
        {
            ...
            bool isCueBall = CaromGameLogic.isCueBall(ball.id, true);
