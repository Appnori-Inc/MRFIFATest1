...
namespace Billiards
{
    ...
    public static class VectorExtension
    {
        ...
        public static float RemapClamped(this float value, in (float, float) input, in (float, float) output) => output.Item1 + (output.Item2 - output.Item1) * ((Mathf.Clamp(value, input.Item1, input.Item2) - input.Item1) / (input.Item2 - input.Item1));
