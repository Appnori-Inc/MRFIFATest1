...
namespace NetworkManagement
{
    ...
    public class PlayerProfile
    {
        ...
        public bool canPlayOffline{ get { return true; } }

        public bool canPlayOnLine{ get { return true; } }
    ...
    public class NetworkManager
    {
        ...
        public static void InitializeMainPlayer()
        {
            ...
            mainPlayer = new PlayerProfile(social.mainPlayerId, true, null, string.Empty, string.Empty, false, social.GetMainPlayerName(), PlayerState.Online, social.GetMainPlayerCoins(), social.GetMainPlayerPrize());
        }
