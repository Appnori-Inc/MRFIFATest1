        ...
        public static IEnumerator Download(DownloadParameters parameters)
        {
            ...
            else
            {
                ...
                else if (File.Exists(path))
                {
                    ...
                    var www = UnityWebRequest.Get(parameters.localURL);
                    ...
                    if (string.IsNullOrEmpty(www.error))
                    {
                        parameters.SetData(
                            ...
                            (www.downloadHandler as DownloadHandlerTexture).texture,
                            (www.downloadHandler as DownloadHandlerAssetBundle).assetBundle);
                    }
                    else
                    {
                        parameters.isNull = true;
